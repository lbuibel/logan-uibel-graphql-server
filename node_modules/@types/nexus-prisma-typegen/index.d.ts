...
interface NexusPrismaInputs {
  Query: {
    routes: {
  filtering: 'id' | 'createdAt' | 'updatedAt' | 'name' | 'type' | 'miles' | 'startPoint' | 'endPoint' | 'startingElevation' | 'finalElevation' | 'AND' | 'OR' | 'NOT'
  ordering: 'id' | 'createdAt' | 'updatedAt' | 'name' | 'type' | 'miles' | 'startPoint' | 'endPoint' | 'startingElevation' | 'finalElevation'
}
...
interface NexusPrismaTypes {
  ...
  Mutation: {
    ...
    updateManyRoute: 'BatchPayload'
    deleteOneRoute: 'Route'
    deleteManyRoute: 'BatchPayload'
